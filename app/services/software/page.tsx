			...
			<section className="relative h-[400px] sm:h-[500px] w-full overflow-hidden">
				...
				<div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
					...
					<p className="text-base sm:text-lg md:text-xl text-white/90 max-w-2xl md:max-w-3xl mb-6 md:mb-8">
						Custom software solutions, web applications, and mobile
						apps built with cutting-edge technologies to drive your
						business forward.
					</p>
					<Link href="/contact">
						<Button
			...
			<section className="py-12 md:py-20 bg-muted/50">
				<div className="container mx-auto px-4">
					<div className="text-center mb-10 md:mb-16 max-w-3xl mx-auto">
						...
						<h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-foreground">
							Reliable Software Solutions, From Idea to Deployment
						</h2>
						<p className="text-base md:text-lg text-muted-foreground leading-relaxed text-justify sm:text-center">
							At TechMaster Solutions, we ensure you can fully
							rely on us — from conceptualizing your idea to
							delivering a complete, production-ready solution.
							Whether you're solving a complex business problem or
							bringing a new digital product to life, our team
							provides end-to-end support. From software design
							and development to deployment and optimization, we
							take care of every step, ensuring reliability,
			...
			<section className="py-12 md:py-20 bg-background">
				<div className="container mx-auto px-4">
					<div className="text-center mb-10 md:mb-16 max-w-3xl mx-auto">
						...
						<p className="text-base md:text-lg text-muted-foreground">
							From web applications to enterprise software, we
							deliver scalable solutions that meet your unique
							business requirements.
						</p>
					</div>

					{/* Bullet-style service list */}
			...
			<section className="py-12 md:py-20 bg-muted/50">
				<div className="container mx-auto px-4">
					<div className="text-center mb-10 md:mb-16 max-w-3xl mx-auto">
						...
						<h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-foreground"></h2>
						<p className="text-base md:text-lg text-muted-foreground">
							We follow industry best practices with agile
							development to ensure quality, transparency, and
							timely delivery.
						</p>
					</div>
			...
			<section className="py-12 md:py-20 bg-background">
				<div className="container mx-auto px-4">
					<div className="text-center mb-10 md:mb-16 max-w-3xl mx-auto">
						...
						<p className="text-base md:text-lg text-muted-foreground">
							We use the latest frameworks, languages, and tools
							to build robust, scalable, and maintainable software
							solutions.
						</p>
					</div>
									...
									>
										...
										<div className="space-y-2">
											{techs.map((tech, index) => (
												<div
													key={index}
													className="bg-card rounded-lg p-3 text-sm font-medium border text-foreground"
												>
													{tech}
												</div>
											))}
					...
					<div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-6xl mx-auto">
						...
						<div>
							...
							<p className="text-base md:text-lg text-muted-foreground mb-8">
								Our experienced development team delivers
			...
			<section className="py-12 md:py-20 bg-gray-900 dark:bg-gray-950 text-white">
				<div className="container mx-auto px-4 text-center max-w-4xl">
					...
					<p className="text-gray-300 dark:text-gray-400 text-base md:text-lg max-w-2xl mx-auto mb-8">
						...
						custom software solution that drives your business
						success.
					</p>
...
const softwareServices = [
	...
	},
	{
		...
		description:
			"Scalable enterprise solutions including CRM, ERP, and custom business management systems.",
		icon: Cog,
	},
	{
		title: "API Development",
		description:
			"RESTful APIs and microservices architecture for seamless system integration and data exchange.",
		icon: Code,
	},
	{
	...
	},
	{
		...
		description:
			"Skilled developers to extend your team and accelerate project delivery with expertise.",
		icon: Users,
	},
];
...
const developmentProcess = [
	{
		...
		description:
			"Detailed analysis of your business needs and technical requirements.",
	},
	{
		title: "Design & Planning",
		description:
			"System architecture design and project planning with clear milestones.",
	},
	{
		title: "Development",
		description:
	...
	},
	{
		...
		description:
			"Comprehensive testing and smooth deployment to production environment.",
	},
];

const techStack = {
	Frontend: ["React.js", "Next.js", "Vue.js", "TypeScript"],
	Backend: ["Node.js", "Python", "C#", ".NET Core"],
...
const qualityFeatures = [
	{
		...
		description:
			"We follow industry best practices and coding standards for maintainable and scalable code.",
	},
	{
		title: "Comprehensive Testing",
		description:
			"Unit testing, integration testing, and automated testing to ensure software reliability.",
	},
	{
		title: "Security First",
		description:
			"Built-in security measures and regular security audits to protect your data and users.",
	},
	{
		title: "Performance Optimization",
		description:
			"Optimized code and architecture for fast loading times and efficient resource usage.",
	},
	{
		title: "Ongoing Support",
		description:
			"Continuous maintenance, updates, and technical support after project delivery.",
	},
];
