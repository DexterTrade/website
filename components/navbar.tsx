...
import { Code, ChevronDown, Menu, Moon, Sun } from "lucide-react";
					...
					<div className="flex h-14 sm:h-16 md:h-18 lg:h-20 items-center justify-between">
						...
						<div className="flex items-center">
							...
							>
								...
								{/* <div className="flex flex-col">
									...
									>
										<span className="inline xs:hidden capitalize">
											Dexter
										</span>
						...
						<div className="hidden md:flex items-center gap-2 lg:gap-4">
							<Link href="/contact#quote-form">
								<AnimatedButton
									className="bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm sm:text-base h-9 sm:h-10 transition-all duration-300 shadow-md hover:shadow-lg"
									hoverEffect="lift"
									iconAnimation={true}
								>
									Get Started
								...
								>
									...
									>
										<AnimatePresence mode="wait">
											...
											>
												{theme === "dark" ? (
													<Sun className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-blue-500" />
												) : (
						...
						<div className="flex items-center gap-1.5 sm:gap-2 md:hidden">
							...
							<Button
								variant="ghost"
								size="icon"
								className="h-8 w-8 sm:h-9 sm:w-9 bg-blue-50 dark:bg-blue-900/20"
...
function NavItem({
	...
	return (
		<li>
			<Link
				href={href}
				className={`relative px-2 sm:px-3 py-1.5 sm:py-2 rounded-md text-sm sm:text-base font-medium transition-colors flex items-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
					isActive
						? "text-blue-500 dark:text-blue-400"
						: "text-foreground hover:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-blue-900/10"
				}`}
							...
							<Link
								...
								className={`block cursor-pointer text-sm sm:text-base py-1.5 sm:py-2 px-2.5 sm:px-3 rounded-lg ${
									pathname === item.href
										...
										: "hover:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-blue-900/10"
								}`}
